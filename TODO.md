...
- [ ] **task-02-db-setup**: Setup PostgreSQL in Docker and define initial SQLAlchemy models (Company, User). (STUCK - No changes in last 20 mins) -> [!] RE-TRIGGERED: Check database/docker configuration or dependencies.
